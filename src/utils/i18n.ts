...
const EN: Dict = {
  ...
  'avatar.welcome':       'Create your avatar',
  'avatar.hint':          'Upload a photo or describe your ideal avatar, then tap Send',
  'avatar.generating':    'Generating avatar…',
  'avatar.useAsAvatar':   'Use this as avatar',
  'avatar.placeholder':   'Describe your avatar, or paste a photo…',
  'avatar.style.3d':      '3D Cartoon',
  'avatar.style.anime':   'Anime',
  'avatar.style.cyber':   'Cyberpunk',
  'avatar.style.oil':     'Oil Painting',
  'avatar.style.water':   'Watercolor',
  'avatar.style.pixel':   'Pixel Art',
...
const ZH: Dict = {
  ...
  // ── Avatar creator ────────────────────────────────────────────────────────
  'avatar.title':         '创建头像',
  'avatar.welcome':       '创建你的头像',
  'avatar.hint':          '上传一张照片或描述你想要的头像，然后发送',
  'avatar.generating':    '生成头像中…',
  'avatar.useAsAvatar':   '设为我的头像',
  'avatar.placeholder':   '描述你的头像，或粘贴一张照片…',
  'avatar.style.3d':      '3D 卡通',
  'avatar.style.anime':   '动漫',
  'avatar.style.cyber':   '赛博朋克',
  'avatar.style.oil':     '油画',
  'avatar.style.water':   '水彩',
  'avatar.style.pixel':   '像素风',
